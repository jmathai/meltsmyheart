...
<?php if(!empty($children)) { ?>
  <p>
    ...
    <?php foreach($children as $child) { ?>
      <div id="child-<?php echo $child['c_id']; ?>">
        ...
        <p>
          <?php if(count($child['photos']) > 0) { ?>
            ...
            <form action="<?php echo Child::getPageUrl($child); ?>"><button class="yellow"><div>View page</div></button></form> or <a href="/child/delete/<?php echo $child['c_id']; ?>" class="child-delete">delete</a>
          <?php }else{ ?>
            You haven't added any photos of <?php echo $child['c_name']; ?> yet.
            Click the button below to get started.
            <form action="/photos/source/<?php echo $child['c_id']; ?>"><button class="yellow" type="submit"><div>Add photos</div></button></form> or <a href="/child/delete/<?php echo $child['c_id']; ?>" class="child-delete">delete</a>
          <?php } ?>
        </p>
        <hr>
      </div>
